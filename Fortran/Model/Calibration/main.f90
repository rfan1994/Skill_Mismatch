...
real(8) :: pguess(Nparam), param_range(2,Nparam)
    ...
    pguess(2) = 0.5d0; param_range(1,2) = 0.15d0; param_range(2,2) = 1d0                ! e_min 
    pguess(3) = 1.01d0; param_range(1,3) = 1d0; param_range(2,3) = 1.05d0               ! lambda_e	
    pguess(4) = 2d0; param_range(1,4) = 0d0; param_range(2,4) = 5d0                     ! psi
    pguess(5) = 0.6404d0; param_range(1,5) = 0d0; param_range(2,5) = 1d0                ! kappa	
    pguess(6) = 10d0; param_range(1,6) = 5d0; param_range(2,6) = 15d0                   ! alpha_u	
    pguess(7) = 10d0; param_range(1,7) = 5d0; param_range(2,7) = 15d0                   ! alpha_o	
    pguess(8) = 3d0; param_range(1,8) = 2d0; param_range(2,8) = 10d0                    ! lambda_a	
    pguess(9) = 8d0; param_range(1,9) = 2d0; param_range(2,9) = 10d0                    ! lambda_b	
